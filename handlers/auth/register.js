...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const result = await query(
      'INSERT INTO users (email, password, first_name, last_name, phone, is_verified) VALUES ($1, $2, $3, $4, $5, $6) RETURNING id, email, first_name, last_name',
      [email, hashedPassword, first_name || null, last_name || null, phone || null, true]
    );
