-- Complete Database Setup Script for SR Silks
-- Run this ENTIRE script in Neon SQL Editor to complete database initialization

-- Step 1: Ensure all tables exist (safe to run even if they already exist)
...
VALUES (
  'srsilks@gmail.com', 
  '$2a$10$rHIsr28.0b6mApQWvzl0bu85p5jBs9k5vlONhalyUDLsH1AZ5nKOi', 
  'Admin'
)
