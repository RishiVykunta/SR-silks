  ...
  try {
    ...
    if (req.method === 'PUT') {
      ...
      const result = await query(
        ...
        [name, description, price, discount_price, category, occasion_type || null, collection_name, images, size, color, material, features, specifications ? JSON.stringify(specifications) : null, shipping_info, stock, is_active, is_new_arrival, is_featured, id]
      );
